package ru.gotoandstop.vacuum.controllers{
	...
	public class TransformRectangleController extends EventDispatcher implements IDisposable{
		...
		private var tl:IVertex;
		private var t:IVertex;
		private var tr:IVertex;
		private var r:IVertex;
		private var br:IVertex;
		private var b:IVertex;
		private var bl:IVertex;
		private var l:IVertex;
...
//			this.addListenerToVertex(this.a);
			...
			con = new SaveDistanceController(lt as VertexView, this.a as VertexView);
			...
			con2 = new SaveAngleController(lt as VertexView, this.a);
			con2.addDependencyVertex(this.tr);
			con2.addDependencyVertex(this.br);
			con2.addDependencyVertex(this.bl);
			
			con2 = new SaveAngleController(rt as VertexView, this.a);
...
//			this.removeListenerFromVertex(this.a);
		...
		private function addListenerToVertex(vertex:IVertex):void{
			vertex.addEventListener(Event.CHANGE, this.handlerCornerVertexChanged);
		}
		
		private function removeListenerFromVertex(vertex:IVertex):void{
